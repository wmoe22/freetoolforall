export default function HeroSection() {
    return (
        <section className="text-center mb-8 sm:mb-12 px-4 sm:px-0" aria-labelledby="hero-heading"  >
            <div className="inline-flex items-center space-x-2 bg-primary/10 text-primary px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6" role="banner">
            ...
            <h1 id="hero-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 sm:mb-6 leading-tight px-2">
                Essential Tools
