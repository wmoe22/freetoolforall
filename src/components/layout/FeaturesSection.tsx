    ...
    return (
        <section className="py-4 sm:py-6" aria-labelledby="features-heading">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
                ...
                <div className="text-center p-4 sm:p-6 bg-white dark:bg-slate-900 rounded-xl sm:rounded-2xl border border-slate-200 dark:border-slate-800">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-100 dark:bg-orange-950/30 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <Briefcase size={20} className="text-orange-600 sm:hidden" />
                        <Briefcase size={24} className="text-orange-600 hidden sm:block" />
                    </div>
                    <h3 className="font-semibold text-slate-900 dark:text-white mb-2 text-sm sm:text-base">Business Hub</h3>
                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
                ...
                <div className="text-center p-4 sm:p-6 bg-white dark:bg-slate-900 rounded-xl sm:rounded-2xl border border-slate-200 dark:border-slate-800">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-100 dark:bg-red-950/30 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <Lock size={20} className="text-red-600 sm:hidden" />
                        <Lock size={24} className="text-red-600 hidden sm:block" />
                    </div>
                    <h3 className="font-semibold text-slate-900 dark:text-white mb-2 text-sm sm:text-base">Security Hub</h3>
                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
